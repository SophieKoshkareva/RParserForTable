...
xlsx.createBook <- function(x, sheetName, file, missing_value = FALSE, mis_ind, outliers = FALSE, outliers_ind, startR = 1){
  ...
  if (missing_value == TRUE){
   ...
   # xlsx.addTitle(cells, i = "1.1", title = "ѕропущенные значени€", titleStyle = MISSING_VALUE_STYLE)
  }
   ...
   if (outliers == TRUE){
     ...
     #xlsx.addTitle(sheet1, rowIndex = 1, colIndex = 2, title = "¬ыбросы", titleStyle = OUTLIERS_STYLE)
    }
